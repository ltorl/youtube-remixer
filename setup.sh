...
CONFIG_DIR="${RMX_CONFIG_DIR:-$HOME/.config/rmx}"
...
The Mirage series represents a significant achievement in aviation history, showcasing the innovation and engineering prowess of Dassault Aviation. These aircraft have not only defended nations but also set benchmarks in aviation technology, influencing the design of future fighter jets. The Mirage legacy continues to be celebrated for its contribution to both military aviation and aeronautical engineering.

#fyp​​​ #memes​​​ #funny​​​ #shortsvideo​​​ #shorts​​​ #shortvideo​​​ #short​​​ #foryou​​​ #trending​​​    #real​​​ #amazing​​​ #amazingfacts​​​ #youtubeshorts​​​ #youtube​​​ #youtubeshort​​​ #youtubechannel​​​  #dangerous​​​ #goofy​​​ #fantasy​​​ #funnymemesdailyfollow​​​  #wtf​​​ #noway​​​ #story​​​  #viralvideo​​​ #viralshorts​​​ #viralshort​​​
DESC
fi
...
#
# Paths can be overridden with YT_UPLOAD_HOME and RMX_CONFIG_DIR.
...
DESCRIPTION_FILE="${RMX_DESCRIPTION_FILE:-$CONFIG_DIR/description.txt}"
...
HASHTAGS=""
[ -f "$DESCRIPTION_FILE" ] && HASHTAGS=$(cat "$DESCRIPTION_FILE")
